...
namespace Silverback.TestBench.UI.CustomControls;
...
/// </summary>
[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1616:Element return value documentation should have text", Justification = "Imported code")]
[SuppressMessage("Naming", "CA1711:Identifiers should not have incorrect suffix", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1614:Element parameter documentation should have text", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1642:Constructor summary documentation should begin with standard text", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1623:Property summary documentation should match accessors", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1610:Property documentation should have value text", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1629:Documentation text should end with a period", Justification = "Imported code")]
[SuppressMessage("ReSharper", "CognitiveComplexity", Justification = "Imported code")]
[SuppressMessage("ReSharper", "UnusedMember.Global", Justification = "Imported code")]
[SuppressMessage("ReSharper", "EventNeverSubscribedTo.Global", Justification = "Imported code")]
[SuppressMessage("Design", "CA1003:Use generic event handler instances", Justification = "Imported code")]
[SuppressMessage("Style", "IDE0022:Use expression body for method", Justification = "Imported code")]
[SuppressMessage("Naming", "CA1725:Parameter names should match base declaration", Justification = "Imported code")]
[SuppressMessage("ReSharper", "UnassignedField.Global", Justification = "Imported code")]
[SuppressMessage("Naming", "CA1721:Property names should not match get methods", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1401:Fields should be private", Justification = "Imported code")]
[SuppressMessage("Design", "CA1051:Do not declare visible instance fields", Justification = "Imported code")]
[SuppressMessage("ReSharper", "CanSimplifyDictionaryLookupWithTryAdd", Justification = "Imported code")]
[SuppressMessage("Performance", "CA1822:Mark members as static", Justification = "Imported code")]
[SuppressMessage("Design", "CA1034:Nested types should not be visible", Justification = "Imported code")]
[SuppressMessage("ReSharper", "MemberCanBeMadeStatic.Local", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1512:Single-line comments should not be followed by blank line", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1507:Code should not contain multiple blank lines in a row", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.OrderingRules", "SA1201:Elements should appear in the correct order", Justification = "Imported code")]
[SuppressMessage("ReSharper", "InconsistentNaming", Justification = "Imported code")]
[SuppressMessage("ReSharper", "ArrangeObjectCreationWhenTypeEvident", Justification = "Imported code")]
[SuppressMessage("Style", "IDE0040:Add accessibility modifiers", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1400:Access modifier should be declared", Justification = "Imported code")]
[SuppressMessage("Style", "IDE0090:Use \'new(...)\'", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.OrderingRules", "SA1202:Elements should be ordered by access", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.SpacingRules", "SA1028:Code should not contain trailing whitespace", Justification = "Imported code")]
[SuppressMessage("ReSharper", "UnnecessaryWhitespace", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.SpacingRules", "SA1005:Single line comments should begin with single space", Justification = "Imported code")]
[SuppressMessage("ReSharper", "SuggestVarOrType_BuiltInTypes", Justification = "Imported code")]
[SuppressMessage("Style", "IDE0008:Use explicit type", Justification = "Imported code")]
[SuppressMessage("ReSharper", "RedundantBaseConstructorCall", Justification = "Imported code")]
[SuppressMessage("ReSharper", "VirtualMemberCallInConstructor", Justification = "Imported code")]
[SuppressMessage("ReSharper", "SuggestVarOrType_SimpleTypes", Justification = "Imported code")]
[SuppressMessage("ReSharper", "SuggestVarOrType_Elsewhere", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1513:Closing brace should be followed by blank line", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.SpacingRules", "SA1004:Documentation lines should begin with single space", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1515:Single-line comment should be preceded by blank line", Justification = "Imported code")]
[SuppressMessage("Style", "IDE0057:Use range operator", Justification = "Imported code")]
[SuppressMessage("ReSharper", "ArrangeRedundantParentheses", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1119:Statement should not use unnecessary parenthesis", Justification = "Imported code")]
[SuppressMessage("Style", "IDE0011:Add braces", Justification = "Imported code")]
[SuppressMessage("Style", "IDE0047:Remove unnecessary parentheses", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1611:Element parameters should be documented", Justification = "Imported code")]
[SuppressMessage("StyleCop.CSharp.ReadabilityRules", "SA1124:Do not use regions", Justification = "Imported code")]
[SuppressMessage("Performance", "CA1805:Do not initialize unnecessarily", Justification = "Imported code")]
[SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "Imported code")]
public class CustomTableView : View
{
    /// <summary>
    ...
    public CustomTableView(DataTable table)
        : this()
    {
        Table = table;
    }
    ...
    {
        if (!CanSelect || !IsColumnVisible(col))
        {
            return false;
        }
    ...
    ///     The index of the <see cref="Table" /> column you are looking for, use <see cref="DataColumn.Ordinal" />
    /// </param>
    ...
    public void EnsureSelectedCellIsVisible()
    {
        ...
        {
            Console.WriteLine(SelectedRow + " " + RowOffset);
    ...
    private void RenderRow(int row, int rowToRender, ColumnToRender[] columnsToRender)
    {
        ...
        var rowScheme = (Style.RowColorGetter?.Invoke(new RowColorGetterArgs(Table, rowToRender))) ?? ColorScheme;
        ...
        for (int i = 0; i < columnsToRender.Length; i++)
        {
            ...
            if (colorSchemeGetter != null)
            {
                ...
                scheme = colorSchemeGetter(new CellColorGetterArgs(Table, rowToRender, current.Column.Ordinal, val, representation, rowScheme));
