...
namespace Silverback.Integration.Kafka.ConfigClassGenerator
{
    internal static class Program
    {
        ...
        private static void WriteBaseClass()
        {
            ...
            Console.WriteLine("    ///     The base class for the types wrapping the the <see cref=\"Confluent.Kafka.ClientConfig\" />.");
            Console.WriteLine("    /// </summary>");
            Console.WriteLine("    [SuppressMessage(\"\", \"SA1649\", Justification = \"Autogenerated all at once\")]");
            Console.WriteLine("    public abstract class ConfluentClientConfigProxyBase : IValidatableEndpointSettings");
            Console.WriteLine("    {");
            Console.WriteLine("        internal static readonly ConfigurationDictionaryComparer<string, string> ConfluentConfigComparer = new();");
            Console.WriteLine();
