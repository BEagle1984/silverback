...
// using Microsoft.Data.PostgreSql;
...
//
// public sealed class PostgreSqlOutboxReaderFixture : IDisposable
// {
...
//
//     private readonly PostgreSqlConnection _sqliteConnection;
//
...
//     {
//         _outboxSettings = new PostgreSqlOutboxSettings($"Data Source={Guid.NewGuid():N};Mode=Memory;Cache=Shared", "TestOutbox");
//         _sqliteConnection = new PostgreSqlConnection(_outboxSettings.ConnectionString);
//         // _sqliteConnection.Open();
//
//         _dataAccess = new PostgreSqlDataAccess(_sqliteConnection.ConnectionString);
