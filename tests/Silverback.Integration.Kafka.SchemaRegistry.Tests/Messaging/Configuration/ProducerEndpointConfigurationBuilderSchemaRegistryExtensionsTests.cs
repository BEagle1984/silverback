...
public class ProducerEndpointConfigurationBuilderSchemaRegistryExtensionsTests
{
    private readonly IServiceProvider _serviceProvider = Substitute.For<IServiceProvider>();

    public ProducerEndpointConfigurationBuilderSchemaRegistryExtensionsTests()
    {
