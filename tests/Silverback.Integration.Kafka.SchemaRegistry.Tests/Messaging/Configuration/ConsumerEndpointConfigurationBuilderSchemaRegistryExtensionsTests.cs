...
public class ConsumerEndpointConfigurationBuilderSchemaRegistryExtensionsTests
{
    private readonly IServiceProvider _serviceProvider = Substitute.For<IServiceProvider>();

    public ConsumerEndpointConfigurationBuilderSchemaRegistryExtensionsTests()
    {
