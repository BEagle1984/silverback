...
public sealed class MqttLoggerExtensionsTests : IDisposable
{
    ...
    {
        _loggerSubstitute = new LoggerSubstitute<MqttLoggerExtensionsTests>(LogLevel.Trace);
        MappedLevelsLogger<MqttLoggerExtensionsTests> mappedLevelsLogger = new([], _loggerSubstitute);
        _silverbackLogger = new SilverbackLogger<MqttLoggerExtensionsTests>(mappedLevelsLogger);
