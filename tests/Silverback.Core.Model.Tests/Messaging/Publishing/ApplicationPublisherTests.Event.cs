...
public partial class ApplicationPublisherTests
{
    ...
    public void PublishEvent_ShouldPublishWithThrowIfUnhandled(bool throwIfUnhandled)
    {
        ...
        applicationPublisher.PublishEvent(new TestEvent(), throwIfUnhandled);
    ...
    public async Task PublishEventAsync_ShouldPublish()
    {
        ...
        await applicationPublisher.PublishEventAsync(new TestEvent(), false);
    ...
    public async Task PublishEventAsync_ShouldPublishWithThrowIfUnhandled(bool throwIfUnhandled)
    {
        ...
        await applicationPublisher.PublishEventAsync(new TestEvent(), throwIfUnhandled);
