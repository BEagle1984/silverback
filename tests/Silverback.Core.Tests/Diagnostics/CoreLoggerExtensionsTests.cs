...
public class CoreLoggerExtensionsTests
{
    ...
    public void LogBackgroundServiceStarting_ShouldLog()
    {
        ...
        _logger.Received(
            ...
            null,
            "Starting background service Silverback.Tests.Core.Diagnostics.CoreLoggerExtensionsTests+FakeBackgroundService",
            41);
    }
    ...
    public void LogBackgroundServiceException_ShouldLog()
    {
        ...
        _logger.Received(
            ...
            "Background service Silverback.Tests.Core.Diagnostics.CoreLoggerExtensionsTests+FakeBackgroundService execution failed",
            42);
    }
    ...
    public void LogRecurringBackgroundServiceStopped_ShouldLog()
    {
        ...
        _logger.Received(
            LogLevel.Information,
            null,
            "Background service Silverback.Tests.Core.Diagnostics.CoreLoggerExtensionsTests+FakeBackgroundService stopped",
            51);
    }
    ...
    public void LogRecurringBackgroundServiceSleeping_ShouldLog()
    {
        ...
        _logger.Received(
            LogLevel.Debug,
            null,
            "Background service Silverback.Tests.Core.Diagnostics.CoreLoggerExtensionsTests+FakeBackgroundService sleeping for 10000 ms",
            52);
    }
