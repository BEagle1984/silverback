...
public class SilverbackLoggerTests
{
    ...
    public void Log_ShouldUseDefaultLogLevel_WhenMappingIsEmpty()
    {
        ...
        logger.Received(
            ...
            null,
            "Starting background service Silverback.Tests.Core.Diagnostics.SilverbackLoggerTests+TestService");
    }
    ...
    public void Log_ShouldUseExceptionBasedConditionalLogLevelMapping()
    {
        ...
        LoggerSubstitute<SilverbackLoggerTests> logger = new(LogLevel.Warning);
        MappedLevelsLogger<SilverbackLoggerTests> mappedLevelsLogger = new(logLevels, logger);
        SilverbackLogger<SilverbackLoggerTests> silverbackLogger = new(mappedLevelsLogger);
        ...
        logger.Received(
            ...
            "Background service Silverback.Tests.Core.Diagnostics.SilverbackLoggerTests+TestService execution failed");
        logger.Received(
            LogLevel.Error,
    ...
    public void Log_ShouldUseMessageBasedConditionalLogLevelMapping()
    {
        ...
        logger.Received(
            LogLevel.Warning,
            typeof(InvalidOperationException),
            "Background service Silverback.Tests.Core.Diagnostics.SilverbackLoggerTests+TestOtherService execution failed");
    }
