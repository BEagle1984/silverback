...
public partial class TypesCacheTests
{
    ...
    {
        string typeName = "Silverback.Tests.Core.Util.TypesCacheTests+TestObject, Silverback.Core.Tests, Version=42.42.42.42";
    ...
    {
        string typeName = "Silverback.Tests.Core.Util.TypesCacheTests+TestObject, Silverback.Core.Tests";
