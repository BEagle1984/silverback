...
public sealed class KafkaLoggerExtensionsTests : IDisposable
{
    ...
    {
        _loggerSubstitute = new LoggerSubstitute<KafkaLoggerExtensionsTests>(LogLevel.Trace);
        MappedLevelsLogger<KafkaLoggerExtensionsTests> mappedLevelsLogger = new([], _loggerSubstitute);
        _silverbackLogger = new SilverbackLogger<KafkaLoggerExtensionsTests>(mappedLevelsLogger);
