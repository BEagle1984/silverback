...
public class EventStoreRepositoryTests
{
    ...
    {
        PersonInMemoryEventStoreRepository repo = new();
        Person person = new();
    ...
    {
        PersonEventStore eventStore = new() { Id = 12, EntityVersion = 1 };
        ...
        PersonInMemoryEventStoreRepository repo = new(eventStore);

        Person person = repo.GetById(12);
    ...
    public void Store_ConcurrentlyModifyExistingEntity_ExceptionThrown()
    {
        ...
        Person person = repo.GetById(12);
        Person person2 = repo.GetById(12);
    ...
    {
        PersonEventStore eventStore = new() { Id = 12 };
        eventStore.Events.Add(
            new PersonEvent
            {
                SerializedEvent = "{\"NewName\": \"Silverback\"}",
    ...
    public void GetAggregateEntity_ExistingIdWithPastSnapshot_OnlyRelevantEventsApplied()
    {
        ...
        Person entity = repo.GetSnapshotById(12, DateTime.Parse("2000-03-01", CultureInfo.InvariantCulture));
