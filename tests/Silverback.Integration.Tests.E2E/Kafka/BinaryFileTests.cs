...
namespace Silverback.Tests.Integration.E2E.Kafka
{
    public class BinaryFileTests : E2ETestFixture
    {
        ...
        public async Task BinaryFile_ForcingBinaryFileSerializerWithoutTypeHeader_Consumed()
        {
            ...
            SpyBehavior.InboundEnvelopes[0].Headers.GetValue(DefaultMessageHeaders.MessageType).Should().BeNull();
            SpyBehavior.InboundEnvelopes[1].Headers.GetValue(DefaultMessageHeaders.MessageType).Should().BeNull();
        ...
        public async Task BinaryFile_ForcingTypedBinaryFileSerializerWithWrongTypeHeader_Consumed()
        {
            ...
            SpyBehavior.InboundEnvelopes[0].Headers.GetValue(DefaultMessageHeaders.MessageType).Should().NotBeNull();
            SpyBehavior.InboundEnvelopes[1].Headers.GetValue(DefaultMessageHeaders.MessageType).Should().NotBeNull();

            SpyBehavior.InboundEnvelopes[0].Message.Should().BeOfType<CustomBinaryFileMessage>();
            SpyBehavior.InboundEnvelopes[1].Message.Should().BeOfType<CustomBinaryFileMessage>();

            SpyBehavior.InboundEnvelopes[0].Headers.GetValue("x-custom-header").Should().BeNull();
            SpyBehavior.InboundEnvelopes[1].Headers.GetValue("x-custom-header").Should().BeNull();
        ...
        public async Task BinaryFile_WithCustomHeaders_ProducedAndConsumed()
        {
            ...
            SpyBehavior.InboundEnvelopes[0].Headers.GetValue("x-custom-header").Should().Be("one");
            SpyBehavior.InboundEnvelopes[0].Message.As<CustomBinaryFileMessage>().CustomHeader.Should().Be("one");
            SpyBehavior.InboundEnvelopes[1].Headers.GetValue("x-custom-header").Should().Be("two");
            SpyBehavior.InboundEnvelopes[1].Message.As<CustomBinaryFileMessage>().CustomHeader.Should().Be("two");
