...
public class BatchProducingTests : KafkaTests
{
    public BatchProducingTests(ITestOutputHelper testOutputHelper)
    ...
    // Note: Tests for batch producing via outbox are implemented in the Outbox*Tests
}
