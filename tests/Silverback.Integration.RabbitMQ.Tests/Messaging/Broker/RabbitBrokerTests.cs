...
namespace Silverback.Tests.Integration.RabbitMQ.Messaging.Broker
{
    public class RabbitBrokerTests
    {
        ...
        {
            var producer = _broker.GetProducer(new RabbitExchangeProducerEndpoint("test-endpoint")
            {
        ...
        public void GetProducer_ExchangeEndpoint_SameInstanceIsReturned()
        {
            ...
            var producer2 = _broker.GetProducer(new RabbitExchangeProducerEndpoint("test-endpoint")
            {
                Exchange = new RabbitExchangeConfig { ExchangeType = ExchangeType.Fanout }
            });
        ...
        public void GetProducer_DifferentExchangeEndpoint_DifferentInstanceIsReturned()
        {
            ...
            var producer2 = _broker.GetProducer(new RabbitExchangeProducerEndpoint("other-endpoint")
            {
                Exchange = new RabbitExchangeConfig { ExchangeType = ExchangeType.Fanout }
            });
        ...
        {
            var consumer = _broker.GetConsumer(new RabbitExchangeConsumerEndpoint("test-endpoint")
            {
                Exchange = new RabbitExchangeConfig { ExchangeType = ExchangeType.Fanout }
            });
        ...
        {
            var consumer = _broker.GetConsumer(new RabbitQueueConsumerEndpoint("test-endpoint"));
        ...
        public void GetConsumer_SameExchangeEndpoint_DifferentInstanceIsReturned()
        {
            ...
            var consumer2 = _broker.GetConsumer(new RabbitExchangeConsumerEndpoint("test-endpoint")
            {
                Exchange = new RabbitExchangeConfig { ExchangeType = ExchangeType.Fanout }
            });
        ...
        {
            var consumer = _broker.GetConsumer(new RabbitQueueConsumerEndpoint("test-endpoint"));
            var consumer2 = _broker.GetConsumer(new RabbitQueueConsumerEndpoint("test-endpoint"));
        ...
        public void GetConsumer_DifferentExchangeEndpoint_DifferentInstanceIsReturned()
        {
            ...
            var consumer2 = _broker.GetConsumer(new RabbitExchangeConsumerEndpoint("other-endpoint")
            {
                Exchange = new RabbitExchangeConfig { ExchangeType = ExchangeType.Fanout }
            });
        ...
        {
            var consumer = _broker.GetConsumer(new RabbitQueueConsumerEndpoint("test-endpoint"));
            var consumer2 = _broker.GetConsumer(new RabbitQueueConsumerEndpoint("other-endpoint"));
