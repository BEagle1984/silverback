...
using Silverback.Tests.EventSourcing.EntityFrameworkCore.TestTypes;
using Xunit;

namespace Silverback.Tests.EventSourcing.EntityFrameworkCore.EventStore
{
    public class _dbContextEventStoreRepositoryTests : IDisposable
    {
        private readonly TestDbContext _dbContext;
        private readonly SqliteConnection _conn;

        public _dbContextEventStoreRepositoryTests()
        {
