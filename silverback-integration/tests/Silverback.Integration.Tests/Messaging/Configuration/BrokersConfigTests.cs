...
namespace Silverback.Tests.Messaging.Configuration
{
    ...
    public class BrokersConfigTests
    {
        ...
        {
            _config
                .Add<TestBroker>(c => c.UseServer("server1").WithName("test1"))
                .Add<TestBroker>(c => c.UseServer("server2").WithName("test2"))
                .Add<TestBroker>(c => c.UseServer("server3").WithName("test3"));
        ...
        public void DefaultTest()
        {
            ...
            Assert.That(((TestBroker) _config.Default).ServerName == "server1");
        }
        ...
        public void AddDefaultTest()
        {
            _config
                .Add<TestBroker>(c => c.UseServer("server1").WithName("test1"))
                .Add<TestBroker>(c => c.UseServer("server2").WithName("test2").AsDefault())
                .Add<TestBroker>(c => c.UseServer("server3").WithName("test3"));

            Assert.That(_config.Default, Is.Not.Null);
            Assert.That(_config.Default, Is.InstanceOf<TestBroker>());
            Assert.That(((TestBroker)_config.Default).ServerName == "server2");
        }
        ...
        {
            _config
                .Add<TestBroker>(c => c.UseServer("server1"));
        ...
        public void AddDuplicatedNameTest()
        {
            Assert.That(
                () => _config
                    .Add<TestBroker>(c => c.UseServer("server1").WithName("duplicate"))
                    .Add<TestBroker>(c => c.UseServer("server2").WithName("duplicate")),
        ...
        public void AddDuplicatedDefaultTest()
        {
            Assert.That(
                () => _config
                    .Add<TestBroker>(c => c.UseServer("server1").WithName("broker1").AsDefault())
        ...
        public void GetTest()
        {
            ...
            Assert.That(((TestBroker)res).ServerName == "server2");
        }
