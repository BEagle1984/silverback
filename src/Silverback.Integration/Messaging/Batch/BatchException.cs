...
namespace Silverback.Messaging.Batch
{
    ...
    public class BatchException : SilverbackException
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="BatchException" /> class with the specified message.
        /// </summary>
        /// <param name="message">
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="BatchException" /> class with the specified message and
        ///     inner exception.
        /// </summary>
        /// <param name="message">
        ///     The exception message.
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="BatchException" /> class with the serialized data.
        /// </summary>
        /// <param name="info">
