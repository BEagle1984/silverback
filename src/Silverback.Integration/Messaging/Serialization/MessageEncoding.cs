...
{
    /// <summary>
    ///     Specifies the message encoding used by some <see cref="IMessageSerializer" /> implementations.
    /// </summary>
    public enum MessageEncoding
    {
        /// <summary> Corresponds to <see cref="System.Text.Encoding.Default" />. </summary>
        Default,
