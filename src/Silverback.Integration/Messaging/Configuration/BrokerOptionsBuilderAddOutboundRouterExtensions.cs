...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class BrokerOptionsBuilderAddOutboundRouterExtensions
    {
        ...
        /// </returns>
        public static IBrokerOptionsBuilder AddTransientOutboundRouter(
            this IBrokerOptionsBuilder brokerOptionsBuilder,
            Type routerType)
        {
            Check.NotNull(brokerOptionsBuilder, nameof(brokerOptionsBuilder));

            brokerOptionsBuilder.SilverbackBuilder.Services.AddTransientOutboundRouter(routerType);
        ...
        ///     The <see cref="IBrokerOptionsBuilder" /> so that additional calls can be chained.
        /// </returns>
        public static IBrokerOptionsBuilder AddTransientOutboundRouter<TRouter>(
            this IBrokerOptionsBuilder brokerOptionsBuilder)
            where TRouter : class, IOutboundRouter
        {
            Check.NotNull(brokerOptionsBuilder, nameof(brokerOptionsBuilder));

            brokerOptionsBuilder.SilverbackBuilder.Services.AddTransientOutboundRouter<TRouter>();
            ...
            Func<IServiceProvider, IOutboundRouter> implementationFactory)
        {
            ...
            brokerOptionsBuilder.SilverbackBuilder.Services.AddTransientOutboundRouter(implementationFactory);
        ...
        ///     The <see cref="IBrokerOptionsBuilder" /> so that additional calls can be chained.
        /// </returns>
        public static IBrokerOptionsBuilder AddScopedOutboundRouter(
            this IBrokerOptionsBuilder brokerOptionsBuilder,
            Type routerType)
        {
            Check.NotNull(brokerOptionsBuilder, nameof(brokerOptionsBuilder));

            brokerOptionsBuilder.SilverbackBuilder.Services.AddScopedOutboundRouter(routerType);
        ...
        ///     The <see cref="IBrokerOptionsBuilder" /> so that additional calls can be chained.
        /// </returns>
        public static IBrokerOptionsBuilder AddScopedOutboundRouter<TRouter>(
            this IBrokerOptionsBuilder brokerOptionsBuilder)
            where TRouter : class, IOutboundRouter
        {
            Check.NotNull(brokerOptionsBuilder, nameof(brokerOptionsBuilder));

            brokerOptionsBuilder.SilverbackBuilder.Services.AddScopedOutboundRouter<TRouter>();
            ...
            Func<IServiceProvider, IOutboundRouter> implementationFactory)
        {
            ...
            brokerOptionsBuilder.SilverbackBuilder.Services.AddScopedOutboundRouter(implementationFactory);
