...
namespace Silverback.Messaging.Broker
{
    ...
    ///     <para>
    ///         The <see cref="IComparableOffset" /> interface should be implemented whenever possible to allow the
    ///         exactly-one delivery using the <see cref="OffsetStoredInboundConnector" />.
    ///     </para>
    /// </summary>
