...
{
    /// <summary> The context that is passed along the consumer behaviors pipeline. </summary>
    public class ConsumerPipelineContext
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ConsumerPipelineContext" /> class.
        /// </summary>
        /// <param name="envelopes"> The envelopes containing the messages being processed. </param>
        /// <param name="consumer"> The <see cref="IConsumer" /> that triggered this pipeline. </param>
        ...
        /// <summary> Gets or sets the envelopes containing the messages being processed. </summary>
