...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="HeaderAttribute" /> class specifying the name of the
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether the header must be produced even if the property is set to
    ///     the default value for its declaring type.
    /// </summary>
