...
namespace Silverback.Messaging.Messages
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of <see cref="HeaderAttribute" /> specifying the name of
        ...
        /// <summary>
        ///     Gets or sets a boolean value indicating whether the header must be produced even if the
        ///     property is set to the default value for its declaring type.
        /// </summary>
