...
{
    /// <summary>
    ///     Exposes the methods to write to the outbound queue. Used by the <see cref="DeferredOutboundConnector"/>.
    /// </summary>
    public interface IOutboundQueueWriter
    {
        ...
        /// </summary>
        /// <param name="envelope">The envelope containing the message to be enqueued.</param>
