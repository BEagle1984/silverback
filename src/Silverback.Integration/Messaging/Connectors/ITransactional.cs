...
{
    /// <summary>
    ///     Declares the <c> Commit </c> and <c> Rollback </c> methods, allowing the service to be enlisted into
    ///     the consumer transaction (see <see cref="ConsumerTransactionManager" />).
    /// </summary>
