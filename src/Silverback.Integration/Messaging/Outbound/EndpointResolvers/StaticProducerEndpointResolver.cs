    ...
    where TConfiguration : ProducerConfiguration
{
    ...
    /// <inheritdoc cref="IStaticProducerEndpointResolver.GetEndpoint(ProducerConfiguration)" />
    public ProducerEndpoint GetEndpoint(ProducerConfiguration configuration) =>
