...
public abstract class Sequence : ISequenceImplementation
{
    private readonly MessageStreamProvider<IInboundEnvelope> _streamProvider = new();
    ...
    private readonly ISilverbackLogger<Sequence> _logger;
        ...
        bool trackIdentifiers = true)
    {
        ...
        _logger = context.ServiceProvider.GetRequiredService<ISilverbackLogger<Sequence>>();
    ...
    /// <inheritdoc cref="ISequence.IsRawMessages" />
    public virtual bool IsRawMessages => false;
    ...
    public virtual async ValueTask<AddToSequenceResult> AddAsync(IInboundEnvelope envelope, ISequence? sequence, bool throwIfUnhandled)
    {
        ...
        try
        {
            ...
            int pushedStreamsCount = await _streamProvider.PushAsync(
                    envelope,
                    throwIfUnhandled,
                    static envelope => ActivitySources.UpdateConsumeActivity((IInboundEnvelope)envelope!),
                    envelope,
    ...
    /// </returns>
    protected virtual bool IsLastMessage(IInboundEnvelope envelope) => false;
