...
using Silverback.Messaging.Configuration.Comparers;
        ...
        public void Validate()
        {
            if (ChannelOptions == null)
            {
                throw new EndpointConfigurationException(
                    "ChannelOptions are required to connect with the message broker.");
            }
            ...
            if (ChannelOptions is MqttClientTcpOptions tcpOptions)
            {
                ...
                {
                    throw new EndpointConfigurationException(
                        "ChannelOptions.Server is required to connect with the message broker.");
                }
            }
            else if (ChannelOptions is MqttClientWebSocketOptions webSocketOptions)
            {
                ...
                {
                    throw new EndpointConfigurationException(
                        "ChannelOptions.Uri is required to connect with the message broker.");
                }
            }
        }
