...
/// </summary>
public sealed record MqttDynamicProducerEndpointResolver : DynamicProducerEndpointResolver<MqttProducerEndpoint, MqttProducerConfiguration>
{
    ...
    public override ValueTask<MqttProducerEndpoint> DeserializeAsync(byte[] serializedEndpoint, MqttProducerConfiguration configuration)
    {
