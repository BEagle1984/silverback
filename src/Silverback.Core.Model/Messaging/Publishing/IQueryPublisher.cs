...
namespace Silverback.Messaging.Publishing
{
    ...
    {
        /// <summary>
        ///     Executes the specified query publishing it to the internal bus. The message will be forwarded
        ...
        /// </typeparam>
        /// <param name="queryMessage"> The query to be executed. </param>
        /// <returns> The query result. </returns>
        TResult Execute<TResult>(IQuery<TResult> queryMessage);

        /// <summary>
        ///     Executes the specified queries publishing them to the internal bus. The messages will be
        ...
        ///     The type of the expected query result.
        /// </typeparam>
        /// <param name="queryMessages"> The queries to be executed. </param>
