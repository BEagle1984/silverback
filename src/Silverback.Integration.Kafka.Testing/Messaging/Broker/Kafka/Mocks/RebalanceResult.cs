...
namespace Silverback.Messaging.Broker.Kafka.Mocks
{
    ...
    public class RebalanceResult
    {
        ...
        /// </summary>
        public IReadOnlyDictionary<IMockedConfluentConsumer, IReadOnlyCollection<TopicPartition>> AssignedPartitions
        {
            get;
        }
        ...
        /// </summary>
        public IReadOnlyDictionary<IMockedConfluentConsumer, IReadOnlyCollection<TopicPartition>> RevokedPartitions
        {
            get;
        }
    }
