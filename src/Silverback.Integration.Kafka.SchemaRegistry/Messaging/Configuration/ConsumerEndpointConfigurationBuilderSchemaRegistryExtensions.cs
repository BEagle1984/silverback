...
/// <summary>
///     Adds the <see cref="DeserializeAvro{TMessage,TConfiguration,TBuilder}" />, <see cref="DeserializeJsonUsingSchemaRegistry{TMessage,TConfiguration,TBuilder}" />
///     and <see cref="DeserializeProtobuf{TMessage,TConfiguration,TBuilder}"/>  methods to the <see cref="ConsumerEndpointConfigurationBuilder{TMessage,TConfiguration,TBuilder}" />.
/// </summary>
public static class ConsumerEndpointConfigurationBuilderSchemaRegistryExtensions
{
    ...
    /// <summary>
    ///     Sets the deserializer to an instance of <see cref="ProtobufMessageDeserializer{TMessage}" /> to deserialize
    ///     the consumed Protobuf serialized message.
    /// </summary>
    /// <typeparam name="TMessage">
    ///     The type of the messages being consumed.
    /// </typeparam>
    ...
    /// </param>
    /// <param name="deserializerBuilderAction">
    ///     An optional <see cref="Action{T}" /> that takes the <see cref="ProtobufMessageDeserializerBuilder" /> and configures it.
    /// </param>
    /// <returns>
    ///     The endpoint builder so that additional calls can be chained.
    /// </returns>
    public static TBuilder DeserializeProtobuf<TMessage, TConfiguration, TBuilder>(
        this ConsumerEndpointConfigurationBuilder<TMessage, TConfiguration, TBuilder> endpointBuilder,
        Action<ProtobufMessageDeserializerBuilder>? deserializerBuilderAction = null)
        ...
        where TBuilder : ConsumerEndpointConfigurationBuilder<TMessage, TConfiguration, TBuilder>
    {
        ...
        ProtobufMessageDeserializerBuilder deserializerBuilder = new(endpointBuilder.ServiceProvider.GetRequiredService<IConfluentSchemaRegistryClientFactory>());
