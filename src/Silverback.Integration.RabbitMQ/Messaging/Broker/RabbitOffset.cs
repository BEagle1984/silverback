...
namespace Silverback.Messaging.Broker
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="RabbitOffset" /> class. </summary>
        /// <param name="consumerTag"> The consumer identifier. </param>
        /// <param name="deliveryTag"> The delivery (message) identifier. </param>
        ...
        /// <summary> Gets the consumer identifier. </summary>
        public string ConsumerTag { get; }

        /// <summary> Gets the delivery (message) identifier. </summary>
