...
{
    /// <summary> Serializes and deserializes the messages sent through Kafka. </summary>
    public interface IKafkaMessageSerializer : IMessageSerializer
    {
        /// <summary> Serializes the specified key string into a byte array. </summary>
        ...
        /// <summary> Deserializes the byte array back into a key string. </summary>
