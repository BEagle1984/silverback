...
namespace Silverback.Messaging.Messages
{
    ...
    public class KafkaStatisticsEvent : IKafkaEvent
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="KafkaStatisticsEvent" /> class. </summary>
        /// <param name="rawJson"> The raw statistics JSON as received from the underlying librdkafka. </param>
        ...
        /// <summary> Gets the statistics as typed <see cref="KafkaStatistics" /> object. </summary>
