...
namespace Silverback.Messaging.Configuration
{
    public abstract class ConfluentClientConfigProxy
    {
        ...
        /// <summary>
        ///     SASL mechanism to use for authentication. Supported: GSSAPI, PLAIN, SCRAM-SHA-256, SCRAM-SHA-512. **NOTE**:
        ///     Despite the name, you may not configure more than one mechanism.
        /// </summary>
        public Confluent.Kafka.SaslMechanism? SaslMechanism
        {
            get => ConfluentBaseConfig.SaslMechanism;
            set => ConfluentBaseConfig.SaslMechanism = value;
        }

        /// <summary>
        ///     This field indicates the number of acknowledgements the leader broker must receive from ISR brokers before
        ///     responding to the request: Zero=Broker does not send any response/ack to client, One=The leader will write the
        ///     record to its local log but will respond without awaiting full acknowledgement from all followers. All=Broker will
        ///     block until message is committed by all in sync replicas (ISRs). If there are less than min.insync.replicas (broker
        ///     configuration) in the ISR set the produce request will fail.
        /// </summary>
        public Confluent.Kafka.Acks? Acks
        {
            get => ConfluentBaseConfig.Acks;
            set => ConfluentBaseConfig.Acks = value;
        }

        ///<summary> Client identifier. default: rdkafka importance: low </summary>
        public string ClientId
        {
            get => ConfluentBaseConfig.ClientId;
            set => ConfluentBaseConfig.ClientId = value;
        }
        ...
        {
            get => ConfluentBaseConfig.BootstrapServers;
            set => ConfluentBaseConfig.BootstrapServers = value;
        }
        ...
        ///     Apache Kafka documentation). default: 1000000 importance: medium
        /// </summary>
        public int? MessageMaxBytes
        {
            get => ConfluentBaseConfig.MessageMaxBytes;
            set => ConfluentBaseConfig.MessageMaxBytes = value;
        }
        ...
        {
            get => ConfluentBaseConfig.MessageCopyMaxBytes;
            set => ConfluentBaseConfig.MessageCopyMaxBytes = value;
        }

        /// <summary>
        ///     Maximum Kafka protocol response message size. This serves as a safety precaution to avoid memory exhaustion
        ///     in case of protocol hickups. This value must be at least `fetch.max.bytes` + 512 to allow for protocol overhead;
        ///     the value is adjusted automatically unless the configuration property is explicitly set. default: 100000000
        ///     importance: medium
        /// </summary>
        public int? ReceiveMessageMaxBytes
        {
            get => ConfluentBaseConfig.ReceiveMessageMaxBytes;
            set => ConfluentBaseConfig.ReceiveMessageMaxBytes = value;
        }

        /// <summary>
        ///     Maximum number of in-flight requests per broker connection. This is a generic property applied to all broker
        ///     communication, however it is primarily relevant to produce requests. In particular, note that other mechanisms
        ///     limit the number of outstanding consumer fetch request per broker to one. default: 1000000 importance: low
        /// </summary>
        public int? MaxInFlight
        {
            get => ConfluentBaseConfig.MaxInFlight;
            set => ConfluentBaseConfig.MaxInFlight = value;
        }
        ...
        {
            get => ConfluentBaseConfig.MetadataRequestTimeoutMs;
            set => ConfluentBaseConfig.MetadataRequestTimeoutMs = value;
        }

        /// <summary>
        ///     Period of time in milliseconds at which topic and broker metadata is refreshed in order to proactively
        ///     discover any new brokers, topics, partitions or partition leader changes. Use -1 to disable the intervalled refresh
        ///     (not recommended). If there are no locally referenced topics (no topic objects created, no messages produced, no
        ///     subscription or no assignment) then only the broker list will be refreshed every interval but no more often than
        ///     every 10s. default: 300000 importance: low
        /// </summary>
        public int? TopicMetadataRefreshIntervalMs
        {
            get => ConfluentBaseConfig.TopicMetadataRefreshIntervalMs;
            set => ConfluentBaseConfig.TopicMetadataRefreshIntervalMs = value;
        }
        ...
        {
            get => ConfluentBaseConfig.MetadataMaxAgeMs;
            set => ConfluentBaseConfig.MetadataMaxAgeMs = value;
        }

        /// <summary>
        ///     When a topic loses its leader a new metadata request will be enqueued with this initial interval,
        ///     exponentially increasing until the topic metadata has been refreshed. This is used to recover quickly from
        ///     transitioning leader brokers. default: 250 importance: low
        /// </summary>
        public int? TopicMetadataRefreshFastIntervalMs
        {
            get => ConfluentBaseConfig.TopicMetadataRefreshFastIntervalMs;
            set => ConfluentBaseConfig.TopicMetadataRefreshFastIntervalMs = value;
        }
        ...
        {
            get => ConfluentBaseConfig.TopicMetadataRefreshSparse;
            set => ConfluentBaseConfig.TopicMetadataRefreshSparse = value;
        }
        ...
        {
            get => ConfluentBaseConfig.TopicBlacklist;
            set => ConfluentBaseConfig.TopicBlacklist = value;
        }

        /// <summary>
        ///     A comma-separated list of debug contexts to enable. Detailed Producer debugging: broker,topic,msg. Consumer:
        ///     consumer,cgrp,topic,fetch default: '' importance: medium
        /// </summary>
        public string Debug
        {
            get => ConfluentBaseConfig.Debug;
            set => ConfluentBaseConfig.Debug = value;
        }

        /// <summary>
        ///     Default timeout for network requests. Producer: ProduceRequests will use the lesser value of
        ///     `socket.timeout.ms` and remaining `message.timeout.ms` for the first message in the batch. Consumer: FetchRequests
        ///     will use `fetch.wait.max.ms` + `socket.timeout.ms`. Admin: Admin requests will use `socket.timeout.ms` or
        ///     explicitly set `rd_kafka_AdminOptions_set_operation_timeout()` value. default: 60000 importance: low
        /// </summary>
        public int? SocketTimeoutMs
        {
            get => ConfluentBaseConfig.SocketTimeoutMs;
            set => ConfluentBaseConfig.SocketTimeoutMs = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SocketSendBufferBytes;
            set => ConfluentBaseConfig.SocketSendBufferBytes = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SocketReceiveBufferBytes;
            set => ConfluentBaseConfig.SocketReceiveBufferBytes = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SocketKeepaliveEnable;
            set => ConfluentBaseConfig.SocketKeepaliveEnable = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SocketNagleDisable;
            set => ConfluentBaseConfig.SocketNagleDisable = value;
        }

        /// <summary>
        ///     Disconnect from broker when this number of send failures (e.g., timed out requests) is reached. Disable with
        ///     0. WARNING: It is highly recommended to leave this setting at its default value of 1 to avoid the client and broker
        ...
        {
            get => ConfluentBaseConfig.SocketMaxFails;
            set => ConfluentBaseConfig.SocketMaxFails = value;
        }
        ...
        {
            get => ConfluentBaseConfig.BrokerAddressTtl;
            set => ConfluentBaseConfig.BrokerAddressTtl = value;
        }
        ...
        {
            get => ConfluentBaseConfig.BrokerAddressFamily;
            set => ConfluentBaseConfig.BrokerAddressFamily = value;
        }

        /// <summary>
        ///     The initial time to wait before reconnecting to a broker after the connection has been closed. The time is
        ///     increased exponentially until `reconnect.backoff.max.ms` is reached. -25% to +50% jitter is applied to each
        ///     reconnect backoff. A value of 0 disables the backoff and reconnects immediately. default: 100 importance: medium
        /// </summary>
        public int? ReconnectBackoffMs
        {
            get => ConfluentBaseConfig.ReconnectBackoffMs;
            set => ConfluentBaseConfig.ReconnectBackoffMs = value;
        }

        /// <summary>
        ///     The maximum time to wait before reconnecting to a broker after the connection has been closed. default: 10000
        ///     importance: medium
        /// </summary>
        public int? ReconnectBackoffMaxMs
        {
            get => ConfluentBaseConfig.ReconnectBackoffMaxMs;
            set => ConfluentBaseConfig.ReconnectBackoffMaxMs = value;
        }

        /// <summary>
        ///     librdkafka statistics emit interval. The application also needs to register a stats callback using
        ///     `rd_kafka_conf_set_stats_cb()`. The granularity is 1000ms. A value of 0 disables statistics. default: 0 importance:
        ///     high
        /// </summary>
        public int? StatisticsIntervalMs
        {
            get => ConfluentBaseConfig.StatisticsIntervalMs;
            set => ConfluentBaseConfig.StatisticsIntervalMs = value;
        }

        /// <summary>
        ///     Disable spontaneous log_cb from internal librdkafka threads, instead enqueue log messages on queue set with
        ///     `rd_kafka_set_log_queue()` and serve log callbacks or events through the standard poll APIs. **NOTE**: Log messages
        ///     will linger in a temporary queue until the log queue has been set. default: false importance: low
        /// </summary>
        public bool? LogQueue
        {
            get => ConfluentBaseConfig.LogQueue;
            set => ConfluentBaseConfig.LogQueue = value;
        }
        ...
        {
            get => ConfluentBaseConfig.LogThreadName;
            set => ConfluentBaseConfig.LogThreadName = value;
        }
        ...
        {
            get => ConfluentBaseConfig.LogConnectionClose;
            set => ConfluentBaseConfig.LogConnectionClose = value;
        }

        /// <summary>
        ///     Signal that librdkafka will use to quickly terminate on rd_kafka_destroy(). If this signal is not set then
        ///     there will be a delay before rd_kafka_wait_destroyed() returns true as internal threads are timing out their system
        ///     calls. If this signal is set however the delay will be minimal. The application should mask this signal as an
        ///     internal signal handler is installed. default: 0 importance: low
        /// </summary>
        public int? InternalTerminationSignal
        {
            get => ConfluentBaseConfig.InternalTerminationSignal;
            set => ConfluentBaseConfig.InternalTerminationSignal = value;
        }

        /// <summary>
        ///     Request broker's supported API versions to adjust functionality to available protocol features. If set to
        ///     false, or the ApiVersionRequest fails, the fallback version `broker.version.fallback` will be used. **NOTE**:
        ...
        {
            get => ConfluentBaseConfig.ApiVersionRequest;
            set => ConfluentBaseConfig.ApiVersionRequest = value;
        }
        ...
        {
            get => ConfluentBaseConfig.ApiVersionRequestTimeoutMs;
            set => ConfluentBaseConfig.ApiVersionRequestTimeoutMs = value;
        }

        /// <summary>
        ///     Dictates how long the `broker.version.fallback` fallback is used in the case the ApiVersionRequest fails.
        ///     **NOTE**: The ApiVersionRequest is only issued when a new connection to the broker is made (such as after an
        ///     upgrade). default: 0 importance: medium
        /// </summary>
        public int? ApiVersionFallbackMs
        {
            get => ConfluentBaseConfig.ApiVersionFallbackMs;
            set => ConfluentBaseConfig.ApiVersionFallbackMs = value;
        }

        /// <summary>
        ///     Older broker versions (before 0.10.0) provide no way for a client to query for supported protocol features
        ///     (ApiVersionRequest, see `api.version.request`) making it impossible for the client to know what features it may
        ///     use. As a workaround a user may set this property to the expected broker version and the client will automatically
        ///     adjust its feature set accordingly if the ApiVersionRequest fails (or is disabled). The fallback broker version
        ///     will be used for `api.version.fallback.ms`. Valid values are: 0.9.0, 0.8.2, 0.8.1, 0.8.0. Any other value &gt;=
        ///     0.10, such as 0.10.2.1, enables ApiVersionRequests. default: 0.10.0 importance: medium
        /// </summary>
        public string BrokerVersionFallback
        {
            get => ConfluentBaseConfig.BrokerVersionFallback;
            set => ConfluentBaseConfig.BrokerVersionFallback = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SecurityProtocol;
            set => ConfluentBaseConfig.SecurityProtocol = value;
        }

        /// <summary>
        ///     A cipher suite is a named combination of authentication, encryption, MAC and key exchange algorithm used to
        ///     negotiate the security settings for a network connection using TLS or SSL network protocol. See manual page for
        ///     `ciphers(1)` and `SSL_CTX_set_cipher_list(3). default: '' importance: low
        /// </summary>
        public string SslCipherSuites
        {
            get => ConfluentBaseConfig.SslCipherSuites;
            set => ConfluentBaseConfig.SslCipherSuites = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslCurvesList;
            set => ConfluentBaseConfig.SslCurvesList = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslSigalgsList;
            set => ConfluentBaseConfig.SslSigalgsList = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslKeyLocation;
            set => ConfluentBaseConfig.SslKeyLocation = value;
        }

        ///<summary> Private key passphrase (for use with `ssl.key.location` and `set_ssl_cert()`) default: '' importance: low </summary>
        public string SslKeyPassword
        {
            get => ConfluentBaseConfig.SslKeyPassword;
            set => ConfluentBaseConfig.SslKeyPassword = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslKeyPem;
            set => ConfluentBaseConfig.SslKeyPem = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslCertificateLocation;
            set => ConfluentBaseConfig.SslCertificateLocation = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslCertificatePem;
            set => ConfluentBaseConfig.SslCertificatePem = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslCaLocation;
            set => ConfluentBaseConfig.SslCaLocation = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslCrlLocation;
            set => ConfluentBaseConfig.SslCrlLocation = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SslKeystoreLocation;
            set => ConfluentBaseConfig.SslKeystoreLocation = value;
        }

        ///<summary> Client's keystore (PKCS#12) password. default: '' importance: low </summary>
        public string SslKeystorePassword
        {
            get => ConfluentBaseConfig.SslKeystorePassword;
            set => ConfluentBaseConfig.SslKeystorePassword = value;
        }

        /// <summary>
        ///     Enable OpenSSL's builtin broker (server) certificate verification. This verification can be extended by the
        ///     application by implementing a certificate_verify_cb. default: true importance: low
        /// </summary>
        public bool? EnableSslCertificateVerification
        {
            get => ConfluentBaseConfig.EnableSslCertificateVerification;
            set => ConfluentBaseConfig.EnableSslCertificateVerification = value;
        }

        /// <summary>
        ///     Endpoint identification algorithm to validate broker hostname using broker certificate. https - Server
        ///     (broker) hostname verification as specified in RFC2818. none - No endpoint verification. OpenSSL &gt;= 1.0.2
        ///     required. default: none importance: low
        /// </summary>
        public Confluent.Kafka.SslEndpointIdentificationAlgorithm? SslEndpointIdentificationAlgorithm
        {
            get => ConfluentBaseConfig.SslEndpointIdentificationAlgorithm;
            set => ConfluentBaseConfig.SslEndpointIdentificationAlgorithm = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SaslKerberosServiceName;
            set => ConfluentBaseConfig.SaslKerberosServiceName = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SaslKerberosPrincipal;
            set => ConfluentBaseConfig.SaslKerberosPrincipal = value;
        }

        /// <summary>
        ///     Shell command to refresh or acquire the client's Kerberos ticket. This command is executed on client creation
        ///     and every sasl.kerberos.min.time.before.relogin (0=disable). %{config.prop.name} is replaced by corresponding
        ///     config object value. default: kinit -R -t "%{sasl.kerberos.keytab}" -k %{sasl.kerberos.principal} || kinit -t
        ///     "%{sasl.kerberos.keytab}" -k %{sasl.kerberos.principal} importance: low
        /// </summary>
        public string SaslKerberosKinitCmd
        {
            get => ConfluentBaseConfig.SaslKerberosKinitCmd;
            set => ConfluentBaseConfig.SaslKerberosKinitCmd = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SaslKerberosKeytab;
            set => ConfluentBaseConfig.SaslKerberosKeytab = value;
        }
        ...
        {
            get => ConfluentBaseConfig.SaslKerberosMinTimeBeforeRelogin;
            set => ConfluentBaseConfig.SaslKerberosMinTimeBeforeRelogin = value;
        }

        ///<summary> SASL username for use with the PLAIN and SASL-SCRAM-.. mechanisms default: '' importance: high </summary>
        public string SaslUsername
        {
            get => ConfluentBaseConfig.SaslUsername;
            set => ConfluentBaseConfig.SaslUsername = value;
        }

        ///<summary> SASL password for use with the PLAIN and SASL-SCRAM-.. mechanism default: '' importance: high </summary>
        public string SaslPassword
        {
            get => ConfluentBaseConfig.SaslPassword;
            set => ConfluentBaseConfig.SaslPassword = value;
        }

        /// <summary>
        ///     SASL/OAUTHBEARER configuration. The format is implementation-dependent and must be parsed accordingly. The
        ///     default unsecured token implementation (see https://tools.ietf.org/html/rfc7515#appendix-A.5) recognizes
        ///     space-separated name=value pairs with valid names including principalClaimName, principal, scopeClaimName, scope,
        ///     and lifeSeconds. The default value for principalClaimName is "sub", the default value for scopeClaimName is
        ///     "scope", and the default value for lifeSeconds is 3600. The scope value is CSV format with the default value being
        ///     no/empty scope. For example: `principalClaimName=azp principal=admin scopeClaimName=roles scope=role1,role2
        ///     lifeSeconds=600`. In addition, SASL extensions can be communicated to the broker via `extension_NAME=value`. For
        ///     example: `principal=admin extension_traceId=123` default: '' importance: low
        /// </summary>
        public string SaslOauthbearerConfig
        {
            get => ConfluentBaseConfig.SaslOauthbearerConfig;
            set => ConfluentBaseConfig.SaslOauthbearerConfig = value;
        }

        /// <summary>
        ///     Enable the builtin unsecure JWT OAUTHBEARER token handler if no oauthbearer_refresh_cb has been set. This
        ///     builtin handler should only be used for development or testing, and not in production. default: false importance:
        ///     low
        /// </summary>
        public bool? EnableSaslOauthbearerUnsecureJwt
        {
            get => ConfluentBaseConfig.EnableSaslOauthbearerUnsecureJwt;
            set => ConfluentBaseConfig.EnableSaslOauthbearerUnsecureJwt = value;
        }

        /// <summary>
        ///     List of plugin libraries to load (; separated). The library search path is platform dependent (see dlopen(3)
        ///     for Unix and LoadLibrary() for Windows). If no filename extension is specified the platform-specific extension
        ///     (such as .dll or .so) will be appended automatically. default: '' importance: low
        /// </summary>
        public string PluginLibraryPaths
        {
            get => ConfluentBaseConfig.PluginLibraryPaths;
            set => ConfluentBaseConfig.PluginLibraryPaths = value;
        }
        ...
        {
            get => ConfluentBaseConfig.ClientRack;
            set => ConfluentBaseConfig.ClientRack = value;
        }

        /// <summary>
        ///     The maximum length of time (in milliseconds) before a cancellation request is acted on. Low values may result
        ///     in measurably higher CPU usage. default: 100 range: 1 &lt;= dotnet.cancellation.delay.max.ms &lt;= 10000
        ///     importance: low
        /// </summary>
        public int CancellationDelayMaxMs
        {
            set => ConfluentBaseConfig.CancellationDelayMaxMs = value;
        }
    }

    public abstract class ConfluentConsumerConfigProxy : ConfluentClientConfigProxy
    {
        internal override Confluent.Kafka.ClientConfig ConfluentBaseConfig { get; } =
        ...
        ///     <see cref="M:Confluent.Kafka.Consumer`2.Consume(System.TimeSpan)" /> method. Disabling fields that you do not
        ///     require will improve throughput and reduce memory consumption. Allowed values: headers, timestamp, topic, all, none
        ...
        ///     'smallest','earliest' - automatically reset the offset to the smallest offset, 'largest','latest' - automatically
        ///     reset the offset to the largest offset, 'error' - trigger an error which is retrieved by consuming messages and
        ///     checking 'message-&gt;err'. default: largest importance: high
        /// </summary>
        ...
        ///     (heartbeat.interval.ms) to indicate its liveness to the broker. If no hearts are received by the broker for a group
        ///     member within the session timeout, the broker will remove the consumer from the group and trigger a rebalance. The
        ///     allowed range is configured with the **broker** configuration properties `group.min.session.timeout.ms` and
        ///     `group.max.session.timeout.ms`. Also see `max.poll.interval.ms`. default: 10000 importance: high
        /// </summary>
        ...
        ///     the configured query interval will be divided by ten to more quickly recover in case of coordinator reassignment.
        ...
        ///     consumers. If this interval is exceeded the consumer is considered failed and the group will rebalance in order to
        ///     reassign the partitions to another consumer group member. Warning: Offset commits may be not possible at this
        ///     point. Note: It is recommended to set `enable.auto.offset.store=false` for long-time processing applications and
        ///     then explicitly store offsets (using offsets_store()) *after* message processing, to make sure offsets are not
        ///     auto-committed prior to processing has finished. The interval is checked two times per second. See KIP-62 for more
        ///     information. default: 300000 importance: high
        /// </summary>
        ...
        ///     offsets per partition in the call to assign(). default: true importance: high
        /// </summary>
        ...
        /// <summary>
        ///     Automatically store offset of last message provided to application. The offset store is an in-memory store of
        ///     the next offset to (auto-)commit for each partition. default: true importance: high
        /// </summary>
        ...
        /// <summary>
        ///     Maximum number of kilobytes per topic+partition in the local consumer queue. This value may be overshot by
        ///     fetch.message.max.bytes. This property has higher priority than queued.min.messages. default: 1048576 importance:
        ///     medium
        /// </summary>
        ...
        /// <summary>
        ///     Initial maximum number of bytes per topic+partition to request when fetching messages from the broker. If the
        ///     client encounters a message larger than this value it will gradually try to increase it until the entire message
        ///     can be fetched. default: 1048576 importance: medium
        /// </summary>
        ...
        /// <summary>
        ///     Maximum amount of data the broker shall return for a Fetch request. Messages are fetched in batches by the
        ///     consumer and if the first message batch in the first non-empty partition of the Fetch request is larger than this
        ///     value, then the message batch will still be returned to ensure the consumer can make progress. The maximum message
        ///     batch size accepted by the broker is defined via `message.max.bytes` (broker config) or `max.message.bytes` (broker
        ///     topic config). `fetch.max.bytes` is automatically adjusted upwards to be at least `message.max.bytes` (consumer
        ...
        /// <summary>
        ///     Minimum number of bytes the broker responds with. If fetch.wait.max.ms expires the accumulated data will be
        ///     sent to the client regardless of this setting. default: 1 importance: low
        /// </summary>
        ...
        ///     which have been committed. `read_uncommitted` - return all messages, even transactional messages which have been
        ///     aborted. default: read_committed importance: high
        /// </summary>
        ...
        /// <summary>
        ///     Emit RD_KAFKA_RESP_ERR__PARTITION_EOF event whenever the consumer reaches the end of a partition. default:
        ...
        ///     This check comes at slightly increased CPU usage. default: false importance: medium
        /// </summary>
    ...
    public abstract class ConfluentProducerConfigProxy : ConfluentClientConfigProxy
    {
        ...
        /// <summary>
        ///     Specifies whether or not the producer should start a background poll thread to receive delivery reports and
        ///     event notifications. Generally, this should be set to true. If set to false, you will need to call the Poll
        ///     function manually. default: true importance: low
        /// </summary>
        ...
        ///     true. Set it to false for "fire and forget" semantics and a small boost in performance. default: true importance:
        ///     low
        /// </summary>
        ...
        /// <summary>
        ///     A comma separated list of fields that may be optionally set in delivery reports. Disabling delivery report
        ///     fields that you do not require will improve maximum throughput and reduce memory usage. Allowed values: key, value,
        ///     timestamp, headers, all, none. default: all importance: low
        /// </summary>
        ...
        /// <summary>
        ///     The ack timeout of the producer request in milliseconds. This value is only enforced by the broker and relies
        ///     on `request.required.acks` being != 0. default: 5000 importance: medium
        /// </summary>
        ...
        /// <summary>
        ///     Partitioner: `random` - random distribution, `consistent` - CRC32 hash of key (Empty and NULL keys are mapped
        ...
        ///     for gzip; [0-12] for lz4; only 0 for snappy; -1 = codec-dependent default compression level. default: -1
        ///     importance: medium
        /// </summary>
        ...
        ///     if user-supplied configuration is incompatible. default: false importance: high
        /// </summary>
        ...
        /// <summary>
        ///     **EXPERIMENTAL**: subject to change or removal. When set to `true`, any error that could result in a gap in
        ///     the produced message series when a batch of messages fails, will raise a fatal error (ERR__GAPLESS_GUARANTEE) and
        ///     stop the producer. Messages failing due to `message.timeout.ms` are not covered by this guarantee. Requires
        ///     `enable.idempotence=true`. default: false importance: low
        /// </summary>
        ...
        ///     partitions. This property has higher priority than queue.buffering.max.messages. default: 1048576 importance: high
        /// </summary>
        ...
        ///     batches (MessageSets) to transmit to brokers. A higher value allows larger and more effective (less overhead,
        ...
        ///     message accumulator. If the number of not yet transmitted requests equals or exceeds this number, produce request
        ///     creation that would have otherwise been triggered (for example, in accordance with linger.ms) will be delayed. A
        ///     lower number yields larger and more effective batches. A higher value can improve latency when using compression on
        ///     slow machines. default: 1 importance: low
        /// </summary>
        ...
        ///     message.max.bytes. default: 10000 importance: medium
        /// </summary>
