    ...
    where TEventEntity : class, IEventEntity, new()
{
    ...
    {
        TEventStoreEntity eventStoreEntity = GetEventStoreEntity(domainEntity, false);
    ...
    {
        TEventStoreEntity eventStoreEntity = await GetEventStoreEntityAsync(domainEntity, false).ConfigureAwait(false);
    ...
    protected virtual TEventStoreEntity GetEventStoreEntity(
        ...
        bool addIfNotFound)
    {
        TEventStoreEntity? eventStore = GetEventStoreEntity(domainEntity);
    ...
    protected virtual async Task<TEventStoreEntity> GetEventStoreEntityAsync(
        ...
        bool addIfNotFound)
    {
        TEventStoreEntity? eventStore = await GetEventStoreEntityAsync(domainEntity).ConfigureAwait(false);
        ...
        DateTime? snapshot = null)
    {
        ...
        IEnumerable<TEventEntity> events = snapshot != null
    ...
    protected virtual IEntityEvent MapEvent(TEventEntity eventEntity)
    {
        ...
        {
            Type eventType = TypesCache.GetType(eventEntity.ClrType);
    ...
    private TEventStoreEntity StoreAndPublishEvents(
        ...
        TEventStoreEntity eventStore)
    {
        List<IEntityEvent> newEvents = domainEntity.GetNewEvents().ToList();
        ...
        {
            List<object>? messages = messagesSource.GetMessages()?.ToList();
