...
namespace Silverback.EventStore
{
    ...
    /// </summary>
    /// <typeparam name="TEventEntity"> The type of the related event entity that will be referenced. </typeparam>
    public interface IEventStoreEntity<TEventEntity>
        where TEventEntity : IEventEntity
    {
        /// <summary> Gets the events that have been applied to the domain entity. </summary>
        ICollection<TEventEntity> Events { get; }

        /// <summary> Gets or sets the version of the entity. </summary>
        /// <remarks>
        ...
        /// <summary> Adds the specified events. </summary>
        /// <param name="events"> The events to be stored. </param>
