...
public class EventSourcingException : SilverbackException
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="EventSourcingException" /> class with the specified
    ///     message.
    /// </summary>
    /// <param name="message">
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="EventSourcingException" /> class with the serialized
    ///     data.
    /// </summary>
    /// <param name="info">
