...
namespace Silverback.Configuration
{
    ...
    public partial class SilverbackBuilder
    {
        ...
        ///     The <see cref="SilverbackBuilder" /> that references the <see cref="IServiceCollection" /> to add the subscriber to.
        /// </param>
        /// <param name="implementationFactory">
        ///     The factory that creates the service.
        /// </param>
        ...
        /// </typeparam>
        /// <param name="autoSubscribeAllPublicMethods">
        ///     A boolean value indicating whether all public methods of the specified type have to be automatically subscribed. When set
        ///     to <c>false</c> only the methods decorated with the <see cref="SubscribeAttribute" /> are subscribed.
        /// </param>
        /// <returns>
        ///     The <see cref="SilverbackBuilder" /> so that additional calls can be chained.
        /// </returns>
        ...
        ///     <c>.AddScoped&lt;BaseType, Subscriber&gt;.AddScoped&lt;Subscriber&gt;</c>).
        /// </remarks>
        public SilverbackBuilder AddSubscribers<TSubscriber>(
            TypeSubscriptionOptions options)
            where TSubscriber : class
        {
            Check.NotNull(options, nameof(options));
