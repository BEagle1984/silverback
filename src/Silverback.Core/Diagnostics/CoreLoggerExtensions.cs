...
internal static class CoreLoggerExtensions
{
    ...
    private static readonly Action<ILogger, string, string, Exception?>
        AcquiringLock = SilverbackLoggerMessage.Define<string, string>(CoreLogEvents.AcquiringDistributedLock);

    private static readonly Action<ILogger, string, string, Exception?>
        LockAcquired = SilverbackLoggerMessage.Define<string, string>(CoreLogEvents.DistributedLockAcquired);

    private static readonly Action<ILogger, string, string, Exception?>
        FailedToAcquireLock = SilverbackLoggerMessage.Define<string, string>(CoreLogEvents.FailedToAcquireDistributedLock);

    private static readonly Action<ILogger, string, string, Exception?>
        LockReleased = SilverbackLoggerMessage.Define<string, string>(CoreLogEvents.DistributedLockReleased);

    private static readonly Action<ILogger, string, string, Exception?>
        FailedToReleaseLock = SilverbackLoggerMessage.Define<string, string>(CoreLogEvents.FailedToReleaseDistributedLock);

    private static readonly Action<ILogger, string, string, Exception?>
        FailedToCheckLock = SilverbackLoggerMessage.Define<string, string>(CoreLogEvents.FailedToCheckDistributedLock);

    private static readonly Action<ILogger, string, string, Exception?>
        FailedToSendLockHeartbeat = SilverbackLoggerMessage.Define<string, string>(CoreLogEvents.FailedToSendDistributedLockHeartbeat);
    ...
    private static readonly Action<ILogger, string, Exception?>
        RecurringBackgroundServiceException = SilverbackLoggerMessage.Define<string>(CoreLogEvents.RecurringBackgroundServiceException);
