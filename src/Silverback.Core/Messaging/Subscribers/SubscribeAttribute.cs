...
namespace Silverback.Messaging.Subscribers
{
    ...
    public sealed class SubscribeAttribute : Attribute
    {
        ...
        ///     handling the <b>
        ///         same message
        ///     </b>. The default value is <c>
        ///         true
        ///     </c> (the method will be executed sequentially to other subscribers).
        /// </summary>
        public bool Exclusive { get; set; } = true;

        /// <summary>
        ///     Gets or sets a value indicating whether the method can be executed concurrently when multiple
        ///     messages are fired at the same time (e.g. in a batch). The default value is <c>
        ///         false
        ///     </c> (the messages are processed sequentially).
        /// </summary>
