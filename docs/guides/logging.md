...
2017 | Information | No message consumed within the stall detection threshold ({StallDetectionThreshold}); the consumer will restart &#124; ConsumerName: {ConsumerName} | [StaleConsumer](xref:Silverback.Diagnostics.KafkaLogEvents#Silverback_Diagnostics_KafkaLogEvents_StaleConsumer)
...
4013 | Warning | No matching subscribers found for the produced message &#124; Topic: {Topic} | [NoMatchingSubscribers](xref:Silverback.Diagnostics.MqttLogEvents#Silverback_Diagnostics_MqttLogEvents_NoMatchingSubscribers)
