...
Id | Level | Message | Reference
:-- | :-- | :-- | :--
1001 | Information | Processing consumed message. &#124; endpointName: {endpointName}, messageId: {messageId} | [ProcessingConsumedMessage](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_ProcessingConsumedMessage)
1002 | Error | Error occurred processing the consumed message. &#124; endpointName: {endpointName}, messageId: {messageId} | [ProcessingConsumedMessageError](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_ProcessingConsumedMessageError)
1003 | Critical | Fatal error occurred processing the consumed message. The client will be disconnected. &#124; endpointName: {endpointName}, messageId: {messageId} | [ProcessingConsumedMessageFatalError](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_ProcessingConsumedMessageFatalError)
...
1005 | Information | Message produced. &#124; endpointName: {endpointName}, messageId: {messageId} | [MessageProduced](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_MessageProduced)
...
1011 | Debug | Message '{messageId}' added to {sequenceType} '{sequenceId}'. &#124; length: {sequenceLength} | [MessageAddedToSequence](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_MessageAddedToSequence)
...
1051 | Information | The message(s) will be processed again. &#124; endpointName: {endpointName}, messageId: {messageId} | [RetryMessageProcessing](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_RetryMessageProcessing)
1052 | Information | The message will be moved to the endpoint '{targetEndpointName}'. &#124; endpointName: {endpointName}, messageId: {messageId} | [MessageMoved](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_MessageMoved)
1053 | Information | The message(s) will be skipped. &#124; endpointName: {endpointName}, messageId: {messageId} | [MessageSkipped](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_MessageSkipped)
1054 | Warning | The message belongs to a {sequenceType} and cannot be moved. &#124; endpointName: {endpointName}, messageId: {messageId} | [CannotMoveSequence](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_CannotMoveSequence)
1061 | Warning | Error occurred rolling back, the retry error policy cannot be applied. The consumer will be reconnected. &#124; endpointName: {endpointName}, messageId: {messageId} | [RollbackToRetryFailed](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_RollbackToRetryFailed)
1062 | Warning | Error occurred rolling back the transaction or committing the offset, the skip message error policy cannot be applied. The consumer will be reconnected. &#124; endpointName: {endpointName}, messageId: {messageId} | [RollbackToSkipFailed](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_RollbackToSkipFailed)
...
1082 | Warning | Invalid message consumed: {validationErrors} &#124; endpointName: {endpointName}, messageId: {messageId} | [InvalidMessageConsumed](xref:Silverback.Diagnostics.IntegrationLogEvents#Silverback_Diagnostics_IntegrationLogEvents_InvalidMessageConsumed)
...
Id | Level | Message | Reference
:-- | :-- | :-- | :--
4011 | Debug | Consuming message {messageId} from topic {topic}. &#124; consumerName: {consumerName} | [ConsumingMessage](xref:Silverback.Diagnostics.MqttLogEvents#Silverback_Diagnostics_MqttLogEvents_ConsumingMessage)
4012 | Warning | Failed to acknowledge message {messageId} from topic {topic}. &#124; consumerName: {consumerName} | [AcknowledgeFailed](xref:Silverback.Diagnostics.MqttLogEvents#Silverback_Diagnostics_MqttLogEvents_AcknowledgeFailed)
