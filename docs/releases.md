...
## [3.0.0-beta.18](https://github.com/BEagle1984/silverback/releases/tag/v3.0.0-beta.18)
...
* Upgrade to [Confluent.Kafka 1.5.3](https://github.com/confluentinc/confluent-kafka-dotnet/releases/tag/v1.5.3)
