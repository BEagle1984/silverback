...
* Add message chunking to automatically split the larger messages and rebuild them on the other end (see <xref:producing-chunking> and <xref:consuming-chunking>)
