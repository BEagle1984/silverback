...
## [5.0.0-beta.7](https://github.com/BEagle1984/silverback/releases/tag/v5.0.0-beta.7)
...
Publishing.IPublisher> itself and removed the `UseModel` configuration method (see <xref:bus>)
