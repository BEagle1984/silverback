...
The very first publish will take a bit longer and consume more resources, since all subscribers have to be resolved (intantiated) once for Silverback to figure out which method handles which type of message.
